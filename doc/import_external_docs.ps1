...
$external_docs = @{
    ...
    "uno.themes" = @{ ref="faeacea7878035cf9b4393ba79d6a7f2050f5ac1" } #latest master commit
    ...
    "uno.samples" = @{ ref="37b4310e3f375d9e686e918e0c4e669a6ca22849" } #latest master commit
