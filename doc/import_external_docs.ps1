...
$external_docs = @{
    ...
    "uno.toolkit.ui" = @{ ref="81f3e731baf208b13661629d7badf662b0492868" } #latest main commit
    ...
    "uno.extensions" = @{ ref="434079f8eb6a251afc04b93c81180dd53d51d2fc" } #latest main commit
