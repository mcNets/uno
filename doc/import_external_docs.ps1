...
$external_docs = @{
    ...
    "uno.themes" = @{ ref="d404b686014f67a4406b8268005380ae83cbacd3" } #latest master commit
    "uno.toolkit.ui" = @{ ref="9fdcafb8a85a6881743ad4a237d90c1751e7b219" } #latest main commit
